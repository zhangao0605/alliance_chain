<<template>
    <div>
        <div class="chain_info_row">
            <div class="chain_manage_title">区块信息</div>
        ...
        <el-table
            ...
            <el-table-column
                ...
                align="center">
                <template slot-scope="scope">
                <span class="to_tr color_choose" @click="blockRowClick(scope.row)">{{`#${scope.row.height}`}}</span>
                </template>
            </el-table-column>
            <el-table-column
                label="区块哈希"
                align="center">
                <template slot-scope="scope">
                <span class="to_tr color_choose" @click="blockRowClick(scope.row)">{{scope.row.hash}}</span>
                </template>
            </el-table-column>
            <el-table-column
                label="交易量"
                align="center">
                <template slot-scope="scope">
                <span class="to_tr color_choose" @click="blockRowClick(scope.row)">{{scope.row.txtcount == null ? 0 : scope.row.txtcount}}</span>
                </template>
            </el-table-column>
        </el-table>
    ...
    methods: {
        ...
        pagesChange(e){
            ...
            let obj = {
                page: e,
                pageSize: 10,
                height: /^[0-9]*$/.test(this.input1) ? this.input1 : '',
